   ...
   <div class="m-auto container w-7xl">
    ...
    <div class="my-32 flex flex-cols-2">
      <div class="flex flex-cols-2 flex-1">
          ...
          <div class="">
            <p class="uppercase text-[11px]">quan điểm góc nhìn</p>
            <p class="text-2xl">Tuột mood thì làm gì?</p>
            <div class="flex ite text-[11px]">
              <p class="">VnBIDs</p>
              <p class="uppercase ">February 16, 2020</p>
              <div class="w-1 h-1 rounded-full bg-black mx-3"></div>
              <p class="uppercase ">no comment</p>
            </div>
            <p class="text-4 leading-5">Thực sự để viết thành một bài viết hoàn chỉnh về 1 chủ đề nào đó, mình sẽ cần dành rất nhiều thời gian để nghiên cứu, cung cấp thông tin chính xác, khách quan. Đó là lí do mình ít viết về…</p>
          </div>
      </div>
      <div class="w-30%">
        <a href="" class="">
