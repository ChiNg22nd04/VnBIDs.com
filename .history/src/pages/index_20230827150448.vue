   ...
   <div class="m-auto container w-7xl">
    ...
    <div class="my-14 flex flex-cols-2">
      ...
      <div class="w-30% relative">
        <a href="#" class="block sticky mt-auto top-0 bottom-0">
            <a href="#" class="block uppercase text-[11px] mb-3">INSTAGRAM</a>
            <a href="#" class="block uppercase text-[11px] mb-5">TRENDING POSTS</a>
            <div class="flex flex-cols-2">
               <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/02/rene-bohmer-YeUVDKZWSZ4-unsplash-scaled-e1675275718719.jpg)] bg-center bg-cover w-30 h-full mr-4"></div>
            <div class="">
