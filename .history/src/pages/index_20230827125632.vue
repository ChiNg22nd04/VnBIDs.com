    ...
    <div class="my-14 flex flex-cols-2">
      <div class="flex flex-wrap flex-1">
        <div class="flex flex-cols-2 py-12 border-b w-92% mr-3">
            <div class="bg-[url(https://toaitran.com/wp-content/uploads/2022/10/caleb-fisher-7wdokBOQKGY-unsplash-560x420.jpg)] w-full h-60 bg-cover bg-center mr-5">
            </div>
            <div class="flex justify-between flex-col mx-5">
              <div class="">
                <p class="uppercase text-[11px] text-[#333] hover:text-gray-500">
                  quan điểm góc nhìn</p>
                <p class="text-2xl my-3 hover:text-gray-500">Tuột mood thì làm gì?</p>
                <div class="flex items-center text-[11px] mb-3">
                  <p class="font-bold hover:text-gray-500">VnBIDs</p>
                  <div class="w-[2px] h-[2px] rounded-full bg-black mx-3"></div>
                  <p class="uppercase hover:text-gray-500">February 16, 2020</p>
                  <div class="w-[2px] h-[2px] rounded-full bg-black mx-3"></div>
                  <a href="3" class="uppercase hover:text-gray-500">no comment</a>
                </div>
