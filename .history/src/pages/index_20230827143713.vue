<template>
   <div class="m-auto container w-7xl">
    ...
    <div class="my-14 flex flex-cols-2">
      <div class="flex flex-wrap flex-1">
        <div class="flex flex-cols-2 py-12 border-b w-92% mr-3">
          <a href="" class="block bg-[url(https://toaitran.com/wp-content/uploads/2022/10/caleb-fisher-7wdokBOQKGY-unsplash-560x420.jpg)] w-full h-60 bg-cover bg-center mr-5 bg-no-repeat relative">
            <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10   hover:transition-all hover:ease-in-out hover:duration-150 hidden relative group">
              <div class="group-hover:flex">
                <p class="flex justify-center  uppercase text-white text-10px my-22">xem bài viết<i class="block i-carbon:arrow-right ml-2"></i>
                </p>
            ...
            <!-- <div class="bg-[url(https://toaitran.com/wp-content/uploads/2022/10/caleb-fisher-7wdokBOQKGY-unsplash-560x420.jpg)] w-full h-60 bg-cover bg-center mr-5 relative hover:bg-gray-900">
              <a href="" class=""></a>
              <div class="absolute hidden bottom-0 w-full ">
                <a href="#" class="flex justify-center  uppercase text-white text-10px my-22">
                  xem bài viết
                  <i class="block i-carbon:arrow-right ml-2"></i>
                </a>
                <p class="border-b w-80% mx-auto"></p>
                <a href="#" class="block uppercase text-10px text-center text-white my-4">4 minute read</a>
              </div>
            </div> -->
            <div class="flex justify-between flex-col mx-5">
              <div class="">
                <a href="#" class="block uppercase text-[11px] text-[#333] hover:text-gray-500">
                  quan điểm góc nhìn</a>
