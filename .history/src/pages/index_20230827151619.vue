     ...
     <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/01/hannah-busing-Zyx1bK9mqmA-unsplash-scaled.jpg)] w-full h-140 bg-cover bg-center relative">
      ...
      <div class="my-14 flex flex-cols-2 pt-12">
        ...
        <div class="w-30% relative">
          <div class="sticky mt-auto top-0 bottom-30px">
              <a href="#" class="block uppercase text-[11px] mb-3">INSTAGRAM</a>
              <a href="#" class="block uppercase text-[11px] mb-5">TRENDING POSTS</a>
              <div class="flex flex-cols-2">
                <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/02/rene-bohmer-YeUVDKZWSZ4-unsplash-scaled-e1675275718719.jpg)] bg-center bg-cover w-30 h-30 mr-4">
                </div>
                <div class="flex flex-col justify-between">
                  ...
                  <div class="flex items-center justify-center text-[11px] mb-3">
                    <a href="#" class="font-bold hover:text-gray-500">VnBIDs</a>
                    <div class="w-[2px] h-[2px] rounded-full bg-black mx-3"></div>
