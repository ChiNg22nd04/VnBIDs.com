        ...
        <div class="flex flex-wrap flex-1">
          ...
          <div class="flex flex-cols-2 py-12 border-b w-92% mr-3">
            <div href="" class="block bg-[url(https://toaitran.com/wp-content/uploads/2022/02/pexels-joshua-welch-1624600-643x482.jpg)] w-full h-450px bg-cover bg-center mr-5 bg-no-repeat relative">
              <div class="w-full h-full hover:bg-gray-900 hover:bg-opacity-10   hover:transition-all hover:ease-in-out hover:duration-150 relative group">
                <div  class="block">
                  <a href="#" class="block uppercase text-[11px] text-[#333] hover:text-gray-500">quan điểm góc nhìn</a>
                  <a href="" class="block text-white text-2xl my-3 hover:text-gray-500">Tuột mood thì làm gì?</a>
                  <div class="flex">
                    <div class="text-[#c9c9c9] text-10px flex items-center mr-2">
                      <p class="uppercase">share</p>
                      <i class="block i-carbon:arrow-right ml-2"></i>
