        ...
        <div class="w-30% relative">
          <div class="sticky mt-auto top-0 bottom-30px">
              ...
              <div class="flex flex-cols-2">
                <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/02/rene-bohmer-YeUVDKZWSZ4-unsplash-scaled-e1675275718719.jpg)] bg-center bg-cover w-full h-full mr-4">
                </div>
                <div class="">
