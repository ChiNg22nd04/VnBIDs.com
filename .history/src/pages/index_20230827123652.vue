        ...
        <div class="flex flex-cols-2">
            ...
            <div class="flex justify-between flex-col mx-4">
              <div class="">
                ...
                <p class="text-4 leading-6 text-[#333] m">Thực sự để viết thành một bài viết hoàn chỉnh về 1 chủ đề nào đó, mình sẽ cần dành rất nhiều thời gian để nghiên cứu, cung cấp thông tin chính xác, khách quan. Đó là lí do mình ít viết về…
                </p>
              </div>
              <div class="flex">
