   ...
   <div class="m-auto container w-7xl">
    ...
    <div class="my-32 flex flex-cols-2">
      <div class="flex flex-wrap flex-1 w-96">
        <div class="flex flex-cols-2 flex-80%">
            <div class="bg-[url(https://toaitran.com/wp-content/uploads/2022/10/caleb-fisher-7wdokBOQKGY-unsplash-560x420.jpg)] w-full h-80 bg-cover bg-center mr-4">
            </div>
            <div class="flex justify-between flex-col mx-4">
              <div class="">
                ...
                <p class="text-4 leading-6 text-[#333]">Thực sự để viết thành một bài viết hoàn chỉnh về 1 chủ đề nào đó, mình sẽ cần dành rất nhiều thời gian để nghiên cứu, cung cấp thông tin chính xác, khách quan. Đó là lí do mình ít viết về…
                </p>
              </div>
              <div class="flex">
