    ...
    <div class="my-32 flex flex-cols-2">
      <div class="flex flex-cols-2 flex-1">
          ...
          <div class="">
            ...
            <p class="text-4 leading-5 font-serif">Thực sự để viết thành một bài viết hoàn chỉnh về 1 chủ đề nào đó, mình sẽ cần dành rất nhiều thời gian để nghiên cứu, cung cấp thông tin chính xác, khách quan. Đó là lí do mình ít viết về…</p>
          </div>
      </div>
      <div class="w-30%">
        <a href="" class="">
