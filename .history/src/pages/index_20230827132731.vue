    ...
    <div class="my-14 flex flex-cols-2">
      <div class="flex flex-wrap flex-1">
        <div class="flex flex-cols-2 py-12 border-b w-92% mr-3">
          <a href="" class="block bg-[url(https://toaitran.com/wp-content/uploads/2022/10/caleb-fisher-7wdokBOQKGY-unsplash-560x420.jpg)] w-full h-60 bg-cover bg-center mr-5 bg-no-repeat relative"></a>
