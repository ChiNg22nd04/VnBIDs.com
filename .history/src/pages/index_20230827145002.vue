      ...
      <div class="w-30%">
        <a href="" class="">
          ...
          <div class="flex flex-cols-2">
            <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/02/rene-bohmer-YeUVDKZWSZ4-unsplash-scaled-e1675275718719.jpg)] bg-center bg-cover w-30 h-30">
            </div>
            <div class="">
              <a href="#" class="block uppercase text-[11px] text-[#333] hover:text-gray-500">
                công nghệ
