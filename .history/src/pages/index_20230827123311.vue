    ...
    <div class="my-32 flex flex-cols-2">
      <div class="flex flex-wrap flex-1 w-96">
        <div class="flex flex-cols-2 ">
            <div class="bg-[url(https://toaitran.com/wp-content/uploads/2022/10/caleb-fisher-7wdokBOQKGY-unsplash-560x420.jpg)] w-full h-80 bg-cover bg-center px-3">
            </div>
            <div class="flex justify-between flex-col px-3">
              <div class="">
