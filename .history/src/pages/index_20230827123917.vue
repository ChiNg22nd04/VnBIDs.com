<template>
   <div class="m-auto container w-7xl">
    ...
    <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/01/hannah-busing-Zyx1bK9mqmA-unsplash-scaled.jpg)] w-100 h-140 bg-cover bg-center relative">
    ...
    <div class="my-32 flex flex-cols-2">
      <div class="flex flex-wrap flex-1 w-96">
        <div class="flex flex-cols-2">
            <div class="bg-[url(https://toaitran.com/wp-content/uploads/2022/10/caleb-fisher-7wdokBOQKGY-unsplash-560x420.jpg)] w-full h-70 bg-cover bg-center mr-5">
            </div>
            <div class="flex justify-between flex-col mx-5">
              ...
              <div class="flex">
                <div class="text-[#c9c9c9] text-10px flex items-center">
                  <p class="uppercase">share</p>
                  <i class="block i-carbon:arrow-right ml-2"></i>
                </div>
                <div class="flex text-#333">
                  <i class="block i-ph:facebook-logo"></i>
                  <i class="block i-ph:twitter-logo"></i>
                  <i class="block i-ph:pinterest-logo-fill"></i>
                </div>
              </div>
            </div>
        </div> 
