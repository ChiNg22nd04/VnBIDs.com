      ...
      <div class="">
        <a href="" class="">
          ...
          <div class="flex flex-col">
            <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/02/rene-bohmer-YeUVDKZWSZ4-unsplash-scaled-e1675275718719.jpg)] bg-center bg-cover w-full h-2">
            </div>
          </div>
        </a>
      </div>
