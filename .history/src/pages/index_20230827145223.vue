      ...
      <div class="w-30%">
        <a href="" class="">
          ...
          <div class="flex flex-cols-2">
            <div class="bg-[url(https://toaitran.com/wp-content/uploads/2023/02/rene-bohmer-YeUVDKZWSZ4-unsplash-scaled-e1675275718719.jpg)] bg-center bg-cover w-20 h-20">
            </div>
            <div class="">
              <a href="#" class="block uppercase text-[10px] text-[#333] hover:text-gray-500">
                công nghệ
                </a>
                <a href="" class="block text-2xl my-3 hover:text-gray-500">3 giải thích dễ hiểu về ChatGPT
                </a>
                <div class="flex items-center text-[11px] mb-3">
                  <a href="#" class="font-bold hover:text-gray-500">VnBIDs</a>
                  <div class="w-[2px] h-[2px] rounded-full bg-black mx-3"></div>
